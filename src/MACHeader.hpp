...
namespace wimac {
    ...
    public:
        ...
        /**
         * @brief The size of the MACHeader is always 48 Bit.
         */
    ...
    public:
        ...
        /**
         * @brief Set the number of bytes of uplink bandwidth requested by the SS.
         */
        void setBandwidthRequest( unsigned int _bandwidthRequest )
        {
            bandwidthRequest = _bandwidthRequest;
        }

        /**
         * @brief Get the number of bytes of uplink bandwidth requested by the SS.
         */
        unsigned int getBandwidthRequest() const
        {
        ...
        int getBandwidthRequestType() const
        {
            return bandwidthRequestType;
        }
    ...
    public:
        /**
         * @brief Get the length of the payload in byte including MAC
         * header and CRC if present.
         */
    ...
    private:
        unsigned int fragmentationType;
    ...
    public:
        ...
        unsigned int downlinkChannelID;
        unsigned int configurationChangeCount;
