...
namespace wimac {
    ...
    /**
     * @brief Base for all ConnectionRules that may be added to the ConnectionManager.
     */
    ...
    /**
     * @brief Rule to match with the specified destination address.
     */
    ...
    {
    public:
        DestinationIPRule( wns::service::dll::UnicastAddress destination,
                           UpperConvergence* upperC  );

        virtual bool match( const wns::ldk::CompoundPtr& compound );
    private:
        wns::service::dll::UnicastAddress address_;
        UpperConvergence* upperConvergence_;
    };

    /**
     * @brief Rule to match everything.
     */
    class MatchAllRule :
        public ConnectionRule,
