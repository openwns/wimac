 ...
 */
	...
	public:
		...
		wimac::scheduler::SchedulerInterface* getTxScheduler() const
		{
			return txScheduler.get();
		}

		wimac::scheduler::SchedulerInterface* getRxScheduler() const
		{
	...
	private:
		...
		std::auto_ptr<wimac::scheduler::SchedulerInterface> txScheduler;
		std::auto_ptr<wimac::scheduler::SchedulerInterface> rxScheduler;
	};
}}
#endif
