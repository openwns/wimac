...
#ifndef WIMAC_SCHEDULER_DLSCHEDULER_H
#define WIMAC_SCHEDULER_DLSCHEDULER_H
...
namespace wimac {
    namespace frame {
        ...
        /**
         *  @brief A ContentionCollector that is used in the BS.
         */
        ...
        {
        public:
            SSDLScheduler( wns::ldk::FunctionalUnit* parent, const wns::pyconfig::View& config );
            ...
            void setDuration(const wns::simulator::Time&) {}
