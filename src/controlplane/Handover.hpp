...
namespace wimac{
    ...
    namespace controlplane{
        ...
        /**
         * @brief The command of the Handover functional unit.
         *
        ...
        /**
         * @brief HandoverBS implementation for message exchange in
         * the Base Station.
         *
         * HandoverBS reacts on an MOB_MSHO_REQ() with an
         * MOB_BSHO_RSP.  After reveicing an MOB_HO_IND it will
         * determine all connections and compounds for that subscriber
         * station
         *
         */
        class HandoverBS:
        ...
        /**
         * \brief HandoverSS implementation for message exchange in
         * the Subscriber Station.
         *
         * \li Start HandoverSS with function ho()
         * \li Sends an MOB_MSHO_REQ()
         * \li Receives an MOB_BSHO_RSP()
         * \li React with an MOB_HO_IND()
         + \li Delete all ConnectionIdentifiers
        */
        class HandoverSS :
            public virtual wns::ldk::FunctionalUnit,
            public wns::ldk::CommandTypeSpecifier< HandoverCommand >,
