...
namespace wimac{ namespace controlplane{
        ...
        /**
         * @brief SetupConnectionBS implementation for message exchange in
         * the Base Station.
         *
         * \li SetupConnectionBS reacts on an DSA_REQ[transactionID,
         *     ulQoSPriority, dlQoSPriority ) with an DSA_RSP(transactionID,
         *     ulCID, ulQoSPriority, dlCID, dlQoSPriority)
         * \li After receiving an DSA_ACK it creats new
         *     ConnectionIdentifiers for UL & DL
         *
         */
         ...
         *        Subscriber Station.
         *
         * \li Start SetupConnectionSS with function setupConnection()
         * \li Sends an DSA_REQ[transactionID, ulQoSPriority, dlQoSPriority]
         * \li Receives an DSA_RSP[transactionID,ulCID, ulQoSPriority, dlCID, dlQoSPriority]
         * \li React with an DSA_ACK[transactionID]
         + \li Create  new ConnectionIdentifiers for UL and DL
         *
         */
