...
void HandoverBS::messageNewFrame()
{
             ...
             it = doMOB_HO_IND_.begin(); it != doMOB_HO_IND_.end(); )
    {
        ...
        for(ConnectionIdentifiers::const_iterator it2 = cis.begin();
            it2 !=cis.end(); ++it2)
        {
...
void
HandoverSS::start(wimac::service::handoverStrategy::Interface::Stations targetBaseStations,
                  HandoverCallBackInterface* callBackInterface)
{
    ...
    ConnectionIdentifierPtr basicCI
...
HandoverSS::messageNewFrame()
{
        ...
        it != doMOB_HO_IND_.end();)
    {
        ...
        ConnectionIdentifiers cis =
            friends_.connectionManager->getAllCIForBS( ap );
...
void
HandoverSS::result(wimac::service::handoverStrategy::Interface::Stations ackBaseStations)
{
